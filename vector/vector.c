...
vector *vector_create(copy_constructor_type copy_constructor,
    ...
    new_vector->copy_constructor = copy_constructor;
    new_vector->destructor = destructor;
    new_vector->default_constructor = default_constructor;
    new_vector->capacity = INITIAL_CAPACITY;
    new_vector->size = 0;
    new_vector->array = calloc(INITIAL_CAPACITY, sizeof(void*));
...
void vector_resize(vector *this, size_t n) {
    ...
    if (this->size == n) {
        ...
        this->size = n;
        return;
    } else if (this->size < n && n < this->capacity) {
...
void **vector_at(vector *this, size_t position) {
    assert(this);
    // your code here
    assert(position < this->size && this->array[position] != NULL);
